...
function getConnection() {
	...
	global $db_CognitiveHack_db_Url, $db_CognitiveHack_db_User, $db_CognitiveHack_db_Pass, $db_CognitiveHack_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_CognitiveHack_db_Url.";dbname=".$db_CognitiveHack_db_DbName, $db_CognitiveHack_db_User, $db_CognitiveHack_db_Pass);
